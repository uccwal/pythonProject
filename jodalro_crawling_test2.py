...
def scrape_bid_info():
    ...
    url = "https://www.g2b.go.kr:8081/ep/preparation/prestd/preStdPublishList.do?taskClCd=5&orderbyItem=1&searchType=1&supplierLoginYn=N&instCl=2&instNm=&dminstCd=&taskClCds=5&prodNm=&swbizTgYn=&searchDetailPrdnmNo=&searchDetailPrdnm=&fromRcptDt={}&toRcptDt={}&recordCountPerPage=100".format(
